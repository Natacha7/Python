...
def examen(ruta_archivo_csv: str) -> dict:
    if ruta_archivo_csv.endswith('.csv'):
        try:
            ...
            df_examen = pd.read_csv('https://raw.githubusercontent.com/pepija/mintic-p66/main/examen_colesterol.csv')
        except:
...
print(examen('https://raw.githubusercontent.com/pepija/mintic-p66/main/examen_colesterol.csv'))