...
elaborar un algoritmo que nos diga si el operario recibe incentivos o no, sabiendo que el 
promedio de producción mínima es de 20 unidades a la semana. 
...
promedio = promedio_produccion (lunes, martes, miercoles, jueves, viernes, sabado)
print("\n")
if promedio >= 20:
