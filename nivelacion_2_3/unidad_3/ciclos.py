...
#While -> Se necesita cuando necesitemos mayor generalidad
'''
x = 1
while (x <= 20):
   print (x, end = '-')
...
# para x en el rango (20): # Hasta dónde vamos a iterar y empieza en 0
# print (x + 1, end = '-')

# para x en rango (1,21): # Dónde inicia y dónde termina (estrictamente menor)
# print (x, end = '-')
