...
#cuadradosNuevos = [expresión iteraciones condicionales sobre las iteraciones]
...
def  calculadora ( signo , a , b ):
    #Dependiendo del signo que recibe, solicita la construcción de una función
...
#print (lista (mapa (decrementar, coleccion)))
...
cadena  =  ' ' . join( sorted ( map ( lambda  x : str ( x ) + '' , coleccion )))
print ( "Versión Cadena Colección:" , cadena , type ( cadena ))
'''
...
coleccion . añadir ( 19 )
coleccion . añadir ( 7 )
print ( 'Antes del proceso:' , colección )
cadena  =  '' . unirse ( ordenado ( lista ( conjunto ( mapa ( lambda  x : str ( x ) + '' , colección )))))
print ( "Versión Cadena Colección:" , cadena , type ( cadena ))
'''
