...
asignaturas = ['Español', 'Matemáticas', 'Ciencias Naturales', 'Ciencias Sociales', 'Informatica']
nota_minima = 3
...
promedioNotasAsignatura = list (map (promedio, notas_primer_periodo, notas_segundo_periodo, notas_tercer_periodo, notas_cuarto_periodo))
...
for x in range(0, len(asignaturas)):
    ...
    print("Estado: {}".format('Aprueba la asignatura' if promedioNotasAsignatura[x] >= nota_minima else 'Va reprobando la asignatura'))
    print("\n{}".format(' '.ljust(30, '=')))

print("\nPromedio Final : {}".format(promedio_final))
print("Estado Final: {}".format("\x1b[1;32m"+'Aprobando' if promedio_final >= nota_minima else 'Reprobando'))
