...
def promedio_calificaciones(datos: list) -> dict:
    ...
    for item in datos:
        ...
        if item['cod_grupo'] == "01":
            ...
            Alumnos_grupo1 += 1
            Promedio_calificaciones_grupo1 = round((Total_calificaciones_grupo1/Alumnos_grupo1),2)
        elif item['cod_grupo'] == "02":
            Total_calificaciones_grupo2 += item['calificacion']
            Alumnos_grupo2 += 1
            Promedio_calificaciones_grupo2 = round((Total_calificaciones_grupo2/Alumnos_grupo2),2)
        elif item['cod_grupo'] == "03":
            Total_calificaciones_grupo3 += item['calificacion']
            Alumnos_grupo3 += 1
            Promedio_calificaciones_grupo3 = round((Total_calificaciones_grupo3/Alumnos_grupo3),2)
